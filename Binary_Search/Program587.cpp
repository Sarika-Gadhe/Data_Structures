...
class ArrayX                  // Increasing 
{
    public:
        ...
        bool LinearSearch(int no)                        // TimeComplexity - N
        {
            int i = 0;
            bool bFlag = false;
        ...
        bool BiDirectionalSearch(int no)                          // RimeComplexity -  N/2 
        {
            int iStart = 0;
            int iEnd = 0;
            bool bFlag = false;
        ...
        bool BinarySearchInc(int no)                // Increasing order
        {
        ...
        bool BinarySearchDec(int no)                // Decreasing order
        {
            int iStart = 0, iEnd = 0, iMid = 0;
            bool bFlag = false;
        ...
        bool CheckSortedDec()                             // Time complexity = N-1 or N
        {
            bool bFlag= true;
            int i = 0;
